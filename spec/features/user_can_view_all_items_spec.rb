...
RSpec.feature "When user visits items index page" do
  scenario "a user can view all items" do
    ...
    time_travel = category.powers.create(title: "time travel", description: "You will be able to fly!", price: 5, image_url: "http://www.pngall.com/wp-content/uploads/2017/03/Peter-Pan-Free-Download-PNG.png")
